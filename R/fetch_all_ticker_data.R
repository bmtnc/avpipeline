...
fetch_all_ticker_data <- function(
  ...
  # Fetch balance sheet
  balance_sheet <- fetch_with_logging("balance_sheet", BALANCE_SHEET_CONFIG, datatype = "json")
  Sys.sleep(delay_seconds)
  
  # Fetch income statement
  income_statement <- fetch_with_logging("income_statement", INCOME_STATEMENT_CONFIG, datatype = "json")
  Sys.sleep(delay_seconds)
  
  # Fetch cash flow
  cash_flow <- fetch_with_logging("cash_flow", CASH_FLOW_CONFIG, datatype = "json")
  Sys.sleep(delay_seconds)
  ...
  # Fetch price data
  price_data <- fetch_with_logging("price_data", PRICE_CONFIG, outputsize = "full", datatype = "json")
  Sys.sleep(delay_seconds)
