...
test_that("returns TRUE when position is anomalous", {
  actual <- detect_single_baseline_anomaly(
    test_i,
    test_values,
    test_lookback,
    test_lookahead,
...
test_that("handles edge positions correctly", {
  actual_first <- detect_single_baseline_anomaly(
    1,
    test_values,
    test_lookback,
    test_lookahead,
  ...
  actual_last <- detect_single_baseline_anomaly(
    length(test_values),
    test_values,
    test_lookback,
    test_lookahead,
...
test_that("integrates with helper functions correctly", {
  ...
  baseline_indices <- calculate_baseline(
    test_i,
    length(test_values),
    test_lookback,
    test_lookahead
  ...
  anomaly_result <- detect_baseline_anomaly(
    test_values[test_i],
