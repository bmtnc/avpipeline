...
test_that("returns TRUE when value is anomalous", {
  actual <- detect_baseline_anomaly(
    test_value,
...
test_that("returns TRUE when value is slightly above threshold boundary", {
  above_boundary_value <- test_baseline_median +
    (test_threshold * test_baseline_mad) +
    0.001
  actual <- detect_baseline_anomaly(
    above_boundary_value,
    test_baseline_median,
    test_baseline_mad,
    test_threshold
  )
...
test_that("returns FALSE when value is slightly below threshold boundary", {
  below_boundary_value <- test_baseline_median +
    (test_threshold * test_baseline_mad) -
    0.001
  actual <- detect_baseline_anomaly(
    below_boundary_value,
    test_baseline_median,
    test_baseline_mad,
    test_threshold
  )
...
test_that("calculation is symmetric for positive and negative deviations", {
  ...
  actual_positive <- detect_baseline_anomaly(
    positive_deviation,
    test_baseline_median,
    test_baseline_mad,
    test_threshold
  )
  actual_negative <- detect_baseline_anomaly(
    negative_deviation,
    test_baseline_median,
    test_baseline_mad,
    test_threshold
