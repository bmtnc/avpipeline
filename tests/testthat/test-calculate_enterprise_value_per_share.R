...
test_that("calculate_enterprise_value_per_share handles NA values with coalesce", {
  ...
  result1 <- calculate_enterprise_value_per_share(
    c(100),
    NA_real_,
    c(5),
    c(20),
  ...
  result2 <- calculate_enterprise_value_per_share(
    c(100),
    c(10),
    NA_real_,
    c(20),
  ...
  result3 <- calculate_enterprise_value_per_share(
    c(100),
    c(10),
    c(5),
    NA_real_,
  ...
  result4 <- calculate_enterprise_value_per_share(
    c(100),
    c(10),
    c(5),
    c(20),
